...
class TestTpCollect < Typingpool::Test::Script
  ...
  def test_tp_collect
    with_temp_readymade_project do |dir|
      ...
      copy_fixtures_to_project_dir('tp_collect_', File.join(dir, project_default[:title]))
      begin
        ...
        restore_project_dir_from_fixtures('tp_collect_', File.join(dir, project_default[:title]))
      end #begin
